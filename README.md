# trajectory-thingy
Launch projectiles through the atmosphere and space on a spherical spinning Earth to hit a specified target, then analyze random launch fluctuations. See the top of the .cpp file for technical details, and the "set some constants" section of the code is where you set coordinates, drag coefficient, etc.
